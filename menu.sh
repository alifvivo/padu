...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/alifvivo/ip/main/access > /root/tmp
...
echo -e "${green}════════════════════════════════════════════════════════════${NC}"
echo -e "$PURPLE (•1) $NC PANEL SSH & OPENVPN         $green (•7) $NC SYSTEM MENU "
echo -e "$PURPLE (•2) $NC PANEL WIREGUARDS            $green (•8) $NC CHANGE PORT VPN "
echo -e "$PURPLE (•3) $NC PANEL VMESS & VLESS         $green (•9) $NC Info Script Auto "
echo -e "$PURPLE (•4) $NC PANEL TROJAN                $green (10) $NC Check Usage "
